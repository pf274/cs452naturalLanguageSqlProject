  ...
  try {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: `Your job is to create a SQLite query to answer the question. Use the provided database schema to structure your query. You may only respond with the query as a string. You may only retrieve a maximum of ten rows.
